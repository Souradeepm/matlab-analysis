function run_s2022_lambda_sweep_overlay_3peak_near280K()
% run_s2022_lambda_sweep_overlay_3peak_near280K
% Perform the same lambda sweep on S2022 at a temperature with 3 peaks at lambda=1e-3,
% chosen as the closest such temperature to 280 K.
...
out_xlsx = fullfile(repo_root, 's2022_3peak_near280K_lambda_sweep_overlay.xlsx');
out_png = fullfile(repo_root, 's2022_3peak_near280K_lambda_sweep_overlay.png');
...
fprintf('S2022 same sweep at 3-peak temperature closest to 280 K\n');
